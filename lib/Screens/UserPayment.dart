...
class UserPlanPayment extends StatefulWidget {
  static const routename="UserPlanPayment";
  @override

  State<UserPlanPayment> createState() => _UserPlanPaymentState();
}

class _UserPlanPaymentState extends State<UserPlanPayment> {
...
child: Container(
  ...
  child: Center(child: Text("YEARLY",style: mystyle.getPTSanswhiteItalic(FontWeight.w700, 20))),
                ...
                InkWell(
                    ...
                    onTap: (){
                      Navigator.of(context).pushNamed(Pyament.routename);

                    },
                    child: Image.asset('images/Paypal2 1.png')),
                SizedBox(
                  height: MediaQuery.of(context).size.height * 0.025,
                ),
